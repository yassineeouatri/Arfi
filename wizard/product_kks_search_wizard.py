...
class product_kks_search_wizard(models.Model):
    ...
    type = fields.Selection([('search_magasin','Code magasin'),
        ...
        if self.magasin_id:
            ...
            if self.customer_id:               
                return {
                    ...
                    'view_type': 'form',
                    'name' : name,
                    'views': [(self.env.ref('arfi.view_product_kks_report_tree').id, 'tree')],
                ...
                return {
                    ...
                    'name' : name,
                    'views': [(self.env.ref('arfi.view_product_kks_report_tree').id, 'tree')],
                    'context': {"search_default_magasin_id": self.magasin_id.id,}
                 }
        else :
        ...
        if self.ref_fab_id:  
            ...
            if self.customer_id:
                ...
                return {
                    ...
                    'name' : name,
                    'views': [(self.env.ref('arfi.view_product_kks_report_tree').id, 'tree')],
                    'context': {"search_default_ref_fab": self.ref_fab_id.name,}
                 }
        else :
        ...
        if self.ref_com_id:  
            ...
            if self.customer_id: 
                ...
                return {
                    ...
                    'name' : name,
                    'views': [(self.env.ref('arfi.view_product_kks_report_tree').id, 'tree')],
                    'context': {"search_default_ref_com": self.ref_com_id.name,}
                 }
        else :
