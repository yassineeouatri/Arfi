...
class ReportKKSFACTURE(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('arfi.action_report_productkksfacture', docargs)
...
class ReportKKSFACTURECHANGEMENT(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('arfi.action_report_productkksfacturechangement', docargs)
...
class ReportKKSPVCHANGEMENT(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('arfi.action_report_productkkspvchangement', docargs)
