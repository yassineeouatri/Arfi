...
class ReportPRODUCTOUTILLAGE(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('arfi.action_report_producttemplateoutillage', docargs)
...
class ReportPRODUCTOUTILLAGETARAGE(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('arfi.action_report_producttemplateoutillagetarage', docargs)